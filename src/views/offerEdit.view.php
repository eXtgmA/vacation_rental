    ...
    <div id="new-offer-area">
        ...
        <div id="detail-grid">
            <div id="name-area">
                ...
                <input class="input-field" type="text" name="house-basis-data[name]" id="name" value="<?php echo $house->getName(); ?>" required autofocus>
            </div>
            <div id="city-area">
                <label class="label" for="city">Ort*</label>
                <input class="input-field" type="text" name="house-basis-data[city]" id="city" value="<?php echo $house->getCity(); ?>" required>
            </div>
            <div id="postal-code-area">
                <label class="label" for="postal-code">Postleitzahl*</label>
                <input class="input-field" type="number" name="house-basis-data[postal_code]" id="postal-code" maxlength="5" value="<?php echo $house->getPostalCode(); ?>" required>
            </div>
            <div id="street-area">
                <label class="label" for="street">Straße*</label>
                <input class="input-field" type="text" name="house-basis-data[street]" id="street"
                       value="<?php echo $house->getStreet(); ?>" required>
            </div>
            <div id="house-number-area">
                <label class="label" for="house-number">Hausnummer*</label>
                <input class="input-field" type="number" name="house-basis-data[house_number]" id="house-number" min="1" value="<?php echo $house->getHouseNumber(); ?>" required>
            </div>
            <div id="square-meter-area">
                <label class="label" for="square_meter">Quadratmeter*</label>
                <input class="input-field" type="number" name="house-basis-data[square_meter]" id="square_meter" min="1" value="<?php echo $house->getSquareMeter(); ?>" required>
            </div>
            <div id="room-count-area">
                <label class="label" for="room-count">Anzahl Räume*</label>
                <input class="input-field" type="number" name="house-basis-data[room_count]" id="room-count" min="1" value="<?php echo $house->getRoomCount(); ?>" required>
            </div>
            <div id="max-person-area">
                <label class="label" for="max_person">Anzahl mögliche Personen*</label>
                <input class="input-field" type="number" name="house-basis-data[max_person]" id="max_person" min="1" value="<?php echo $house->getMaxPerson(); ?>" required>
            </div>
            <div id="price-area">
                <label class="label" for="price">Preis pro Nacht*</label>
                <input class="input-field" type="number" name="house-basis-data[price]" id="price" min="1" value="<?php echo $house->getPrice(); ?>" required>
            </div>
            <div id="description-area">
                <label class="label" for="description">Beschreibung*</label>
                <textarea class="input-field" name="house-basis-data[description]" id="description" cols="30" required rows="10"><?php echo $house->getDescription(); ?></textarea>
            </div>
        </div>
