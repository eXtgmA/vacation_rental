<?php
$site = substr(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH), 1);
?>
...
<div class="navparent">
    ...
    <div class="navlinks">
        ...
        <a class="<?php echo $site == 'offer' && $site != 'offer/find' ? 'active' : ''; ?>" href="/offer" title="Haus vermieten"><i class="fa fa-hand-holding-dollar"></i></a>
    ...
    <div class="sandwich-menu">
        ...
        <div class="sandwich-navlinks">
            ...
            <a class="<?php echo $site == 'offer' && $site != 'offer/find' ? 'active' : '' ?>" href="/offer" title="Haus vermieten"><i class="fa fa-hand-holding-dollar"></i> Haus vermieten</a>
